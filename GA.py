...
if __name__ == '__main__':
	...
	# nx.write_graphml(graph,'Liu_reduced3_2.graphml')
	# nx.write_gpickle(graph,'Liu_reduced3_2.gpickle')


	graph = LiuNetwork3Builder()
	nx.write_graphml(graph,'Liu_reduced3_3.graphml')
	nx.write_gpickle(graph,'Liu_reduced3_3.gpickle')
